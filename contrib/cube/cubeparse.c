...
{
       0,    46,    46,    74,   102,   121,   141,   145,   151,   157
};
#endif
...
#define YYBACKUP(Token, Value)                                    \
  do                                                              \
    if (yychar == YYEMPTY)                                        \
      ...
      {                                                           \
        yyerror (result, scanbuflen, escontext, YY_("syntax error: cannot back up")); \
        YYERROR;                                                  \
      }                                                           \
  while (0)
  ...
  if (yydebug)                                                            \
    {                                                                     \
      ...
      yy_symbol_print (stderr,                                            \
                  Kind, Value, result, scanbuflen, escontext); \
      YYFPRINTF (stderr, "\n");                                           \
    }                                                                     \
} while (0)
...
yy_symbol_value_print (FILE *yyo,
                       yysymbol_kind_t yykind, YYSTYPE const * const yyvaluep, NDBOX **result, Size scanbuflen, struct Node *escontext)
{
  FILE *yyoutput = yyo;
  YY_USE (yyoutput);
  YY_USE (result);
                 ...
                 yysymbol_kind_t yykind, YYSTYPE const * const yyvaluep, NDBOX **result, Size scanbuflen, struct Node *escontext)
{
  ...
  yy_symbol_value_print (yyo, yykind, yyvaluep, result, scanbuflen, escontext);
  YYFPRINTF (yyo, ")");
}
...
yy_reduce_print (yy_state_t *yyssp, YYSTYPE *yyvsp,
                 int yyrule, NDBOX **result, Size scanbuflen, struct Node *escontext)
{
  ...
  for (yyi = 0; yyi < yynrhs; yyi++)
    {
      ...
      yy_symbol_print (stderr,
                       ...
                       &yyvsp[(yyi + 1) - (yynrhs)], result, scanbuflen, escontext);
      YYFPRINTF (stderr, "\n");
    }
}
...
do {                                    \
  if (yydebug)                          \
    yy_reduce_print (yyssp, yyvsp, Rule, result, scanbuflen, escontext); \
} while (0)
...
yydestruct (const char *yymsg,
            yysymbol_kind_t yykind, YYSTYPE *yyvaluep, NDBOX **result, Size scanbuflen, struct Node *escontext)
{
  YY_USE (yyvaluep);
  YY_USE (result);
  YY_USE (scanbuflen);
...
int
yyparse (NDBOX **result, Size scanbuflen, struct Node *escontext)
{
...
#line 47 "cubeparse.y"
		...
		if (!write_box(dim, yyvsp[-3], yyvsp[-1], result, escontext))
			YYABORT;
	}
#line 1140 "cubeparse.c"
    break;
...
#line 75 "cubeparse.y"
		...
		if (!write_box(dim, yyvsp[-2], yyvsp[0], result, escontext))
			YYABORT;
	}
#line 1171 "cubeparse.c"
    break;
...
#line 103 "cubeparse.y"
		...
		if (!write_point_as_box(dim, yyvsp[0], result, escontext))
			YYABORT;
	}
#line 1193 "cubeparse.c"
    break;

  case 5: /* box: list  */
#line 122 "cubeparse.y"
        {
		int			dim;
...
#line 1223 "cubeparse.c"
    break;

  case 7: /* paren_list: O_PAREN C_PAREN  */
#line 146 "cubeparse.y"
        {
		yyval = pstrdup("");
	}
#line 1231 "cubeparse.c"
    break;

  case 8: /* list: CUBEFLOAT  */
#line 152 "cubeparse.y"
        {
		/* alloc enough space to be sure whole list will fit */
		yyval = palloc(scanbuflen + 1);
		strcpy(yyval, yyvsp[0]);
	}
#line 1241 "cubeparse.c"
    break;

  case 9: /* list: list COMMA CUBEFLOAT  */
#line 158 "cubeparse.y"
        {
		yyval = yyvsp[-2];
		strcat(yyval, ",");
		strcat(yyval, yyvsp[0]);
	}
#line 1251 "cubeparse.c"
    break;


#line 1255 "cubeparse.c"
...
yyerrlab:
  ...
  if (!yyerrstatus)
    {
      ++yynerrs;
      yyerror (result, scanbuflen, escontext, YY_("syntax error"));
    }
      ...
      if (yychar <= YYEOF)
      ...
      else
        {
          yydestruct ("Error: discarding",
                      yytoken, &yylval, result, scanbuflen, escontext);
          yychar = YYEMPTY;
        }
    }
  ...
  for (;;)
    {
      ...
      yydestruct ("Error: popping",
                  YY_ACCESSING_SYMBOL (yystate), yyvsp, result, scanbuflen, escontext);
      YYPOPSTACK (1);
      yystate = *yyssp;
      YY_STACK_PRINT (yyss, yyssp);
    }
...
`-------------------------------------------------*/
yyexhaustedlab:
  yyerror (result, scanbuflen, escontext, YY_("memory exhausted"));
  yyresult = 2;
  goto yyreturn;
#endif
  ...
  while (yyssp != yyss)
    {
      yydestruct ("Cleanup: popping",
                  YY_ACCESSING_SYMBOL (+*yyssp), yyvsp, result, scanbuflen, escontext);
      YYPOPSTACK (1);
    }
#ifndef yyoverflow
  if (yyss != yyssa)
