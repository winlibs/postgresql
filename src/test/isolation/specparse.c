...
{
       0,     0,     3,     8,     9,    12,    13,    15,    18,    19,
      22,    25,    27,    33,    36,    38,    42,    44,    45,    48,
      50,    53,    56
};
...
{
      12,     0,    -1,    13,    16,    17,    21,    -1,    -1,    13,
      15,    -1,    -1,    15,    -1,     7,     3,    -1,    -1,     9,
       3,    -1,    17,    18,    -1,    18,    -1,     6,     4,    14,
      19,    16,    -1,    19,    20,    -1,    20,    -1,     8,     4,
       3,    -1,    22,    -1,    -1,    22,    23,    -1,    23,    -1,
       5,    24,    -1,    24,     4,    -1,     4,    -1
};
...
static const yytype_uint8 yyrline[] =
{
      ...
      98,   105,   114,   126,   133,   143,   154,   159,   165,   172,
     182,   191,   198
};
#endif
...
#line 57 "specparse.y"
    {
				...
				parseresult.nsetupsqls = (yyvsp[(1) - (4)].ptr_list).nelements;
				parseresult.teardownsql = (yyvsp[(2) - (4)].str);
				parseresult.sessions = (Session **) (yyvsp[(3) - (4)].ptr_list).elements;
...
#line 115 "specparse.y"
    {
				...
				(yyval.session)->name = (yyvsp[(2) - (5)].str);
				(yyval.session)->setupsql = (yyvsp[(3) - (5)].str);
